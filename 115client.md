...
- Cookie 检查状态反馈位于“检查 Cookie”按钮右侧的独立响应式列，显示“尚未检查 Cookie”“正在检查 Cookie…”“Cookie 有效”或失败提示，并随结果变化颜色；底部另有一个不调用 API 的测试按钮，文字固定为“检查 COOKIE”，点击后按蓝色检查中、绿色有效、红色无效三态演示颜色变化。
